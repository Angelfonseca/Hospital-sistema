...
export default function Editar() {
  ...
  return (
    <div className="ContainerFull_Edit">
      ...
      <div>
        <Link to="/">
          <button id="BTN_EditRegresar">Regresar</button>
        </Link>
      </div>
      <form
        className="Con_Form"
        ...
        <div className="Con_Search">
          ...
          <div>
            ...
            <input
              type="search"
              name="Search"
              id="Input_EditSearch_Pro"
              placeholder="Escane el código del producto que deseas editar"
              value={Search}
          ...
          <div>
            ...
            <div>
              ...
              <input
                type="text"
                id="Inputs_Edit_Pro"
                placeholder="Clave Cabms (Nombre)"
                value={cve_cabms}
            ...
            <div>
              ...
              <input
                type="text"
                id="Inputs_Edit_Pro"
                placeholder="Consecutivo (Apellido)"
                value={consecutivo}
          ...
          <div>
            <div>
              ...
              <input
                type="text"
                name=""
                id="Input_EditDesc_Pro"
                placeholder="Descripción detallada del producto"
                value={descrip_bm}
                onChange={(e) => setDescripcionBm(e.target.value)}
                required
              />
            </div>
            <div>
          ...
          <div>
            <div>
              ...
              <input
                type="text"
                id="Inputs_Edit_Pro"
                placeholder="Área-Ubicación del bien"
                value={ubicacion}
